...
- Research documents exist in `_bugs/{bug_name}/research/` directory:
...
2. **Read Research Documents**: Read all documents from `_bugs/{bug_name}/research/` to understand:
...
5. **Create Fix Plan Documents**: Create comprehensive plan documents in `_bugs/{bug_name}/plans/master/`:
