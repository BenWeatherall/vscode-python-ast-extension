...
3. Create investigation documents in `_bugs/{bug_name}/investigation/`:
...
Write a summary of your work to `.cursor/scratchpad.md` for handoff to the next phase. Include: bug name, investigation directory, root cause hypothesis, and affected components.
