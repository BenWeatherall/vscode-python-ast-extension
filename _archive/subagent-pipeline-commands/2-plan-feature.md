...
- Planning documents (or folders named as such with sub-documents) exist in `_features/{feature_name}/planning/` directory:
...
1. **Read Planning Documents**: Read all planning documents from `_features/{feature_name}/planning/` to understand:
...
5. **Create Implementation Plan Documents**: Create comprehensive plan documents in `_features/{feature_name}/plans/master/` that cover all aspects of the implementation. The plan should consist of multiple detailed documents:
