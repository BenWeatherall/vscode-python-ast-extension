...
Review the request / feature idea provided and then generate a set of planning documents for that feature. You should seek to understand and clarify with the user where the feature request fits within the existing system (Reference `@docs/AI_CONTEXT/` for existing project details). The documentation you create should be stored in `_features/{feature_name}/planning`. Remember that any proposals need to adhere to our `@.cursor/rules/development_practices.mdc`
